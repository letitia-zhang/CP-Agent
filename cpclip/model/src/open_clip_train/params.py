...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help="Use EnhancedCLIP with special token support for numerical data integration.",
    )
    parser.add_argument(
        "--special_tokens",
        type=str,
        nargs='+',
        default=['<CONC_TOKEN>', '<TIME_TOKEN>', '<COMPOUND_TOKEN>'],
        help="List of special tokens for EnhancedCLIP. Default: '<CONC_TOKEN>' '<TIME_TOKEN>' '<COMPOUND_TOKEN>'",
    )
    parser.add_argument(
        "--pretrained-image",
        default=False,
    ...
    parser.add_argument(
        ...
        type=int,
        default=256,
        help="Override the context length for the text tower. Default is model specific.",
    )
    parser.add_argument(
        "--compound-dim",
        type=int,
        default=174,
        help="Override the compound embedding dimension. Default is 174.",
    )
